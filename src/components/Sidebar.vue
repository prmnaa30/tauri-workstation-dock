<template>
  <aside
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
      ...
      <div v-for="ws in filteredWorkspaces" :key="ws.id" @click="$emit('select', ws)"
        class="group flex items-center justify-between p-3 rounded-xl bg-slate-800/20 hover:bg-slate-800/60 border hover:border-slate-700/50 cursor-pointer transition-all duration-200"
