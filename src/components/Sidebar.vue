						...
						<div class="space-y-0.5">
							<div
								...
								:class="
									store.currentWorkspaceId === ws.id
										? 'bg-neutral-200/60 dark:bg-neutral-800 text-neutral-950 dark:text-neutral-50'
							...
							>
								...
								>
									...
									<button
										type="button"
										@click.stop="triggerDeleteModal(ws)"
